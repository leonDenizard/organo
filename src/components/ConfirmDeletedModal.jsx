export default function ConfirmDeleteModal({ onConfirm, onCancel, text }) {
  return (
    <div className="fixed w-11/12 lg:w-2/5 m-auto h-1/3 top-0 left-0 right-0 bottom-0 
      backdrop-blur-xl z-10 bg-modal-color 
      flex flex-col justify-center items-center rounded-lg border border-border-color">
      <h2 className="text-xl font-semibold mb-8 rounded-md">{text}</h2>
